...
## AIM:
To write a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element 'n' into it.
...
```
```
![image](https://github.com/user-attachments/assets/b6b14440-87ae-496e-9b35-6a9f0225a8bf)


## RESULT
Thus the program is done and executed.
